...
[ ! -d ~/下载/Apple-Darwin-For-Plymouth/darwin ] && mkdir -p ~/下载/Apple-Darwin-For-Plymouth/darwin
...
cp -r Themes/* ~/.themes/
cp -r Apple-Darwin-For-Plymouth/darwin/* ~/下载/Apple-Darwin-For-Plymouth/darwin/
